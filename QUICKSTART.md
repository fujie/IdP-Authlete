...
# 登録するエンティティ（カンマ区切り）
SUBORDINATE_ENTITIES=https://op.example.com,https://op2.example.com,https://rp-test.example.com
...
AUTHORIZATION_SERVER=https://op.example.com
REDIRECT_URI=https://rp-test.example.com/callback
TRUST_ANCHOR_ID=https://ta.example.com
CLIENT_NAME=Valid OpenID Federation Test Client
CLIENT_URI=https://rp-test.example.com
CONTACTS=admin@rp-test.example.com
...
3. Trust Anchor `https://ta.example.com`を追加
...
3. Trust Anchor `https://ta.example.com`（またはあなたのTrust Anchor URL）を追加
...
3. Entity ID（例: `https://rp-test.example.com`）でクライアントを検索
4. 以下の設定を確認：
   - Client Type: `public`
   - Token Endpoint Auth Method: `none`
